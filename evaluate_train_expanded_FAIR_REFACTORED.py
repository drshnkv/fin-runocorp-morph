...
# For compatibility with evaluation script, create alias
OmorfiHfstWithVoikkoV16Hybrid = FinnishLemmatizer
...
def evaluate_v17_phase10(test_csv: str, results_csv: str):
    ...
    # STEP 1: Load Train-Expanded lemmatizer (FAIR EVALUATION - same methodology as Phase 10)
    ...
    with open(results_csv, 'w', encoding='utf-8', newline='') as outfile:
        fieldnames = ['poem_id', 'word', 'manual_lemma', 'predicted_lemma',
                     'method', 'analysis', 'exact_match', 'is_dialectal', 'is_identity_fallback',
...
def main():
    ...
    results_csv = 'finnish_lemma_evaluation_train_expanded_FAIR.csv'
